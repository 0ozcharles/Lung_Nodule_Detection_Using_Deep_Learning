...
tf.compat.v1.disable_eager_execution()   # ← 禁用 Eager，使 placeholder 可用
import argparse
...
parser.add_argument('--data_path', type=str, default=r"F:\Pulmonary-Nodule-Detection-Based-on-Deep-Learning\Dataset")
...
raw_dir  = os.path.join(data_path, "raw")   # subset0,1,2 放这里
test_dir = os.path.join(data_path, "test")  # subset3 放这里
